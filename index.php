...
<body>
    ...
    <div class="app">
        ...
        <header class="header">
            ...
            <div class="header-profile"> <?php 
                ...
                if ($rol_id == PROFESSOR_ROLE) { ?>
                    <a href="#observaciones" class="access" id="create-notification">
                ...
                if (isset($_SESSION["user"])) { ?>
                    ...
                    <a href="./auth/logout">
                        <svg class="logout" viewBox="0 0 24 24" fill="currentColor" height="24" width="24" focusable="false"><path d="M20 3v18H8v-1h11V4H8V3h12zm-8.9 12.1.7.7 4.4-4.4L11.8 7l-.7.7 3.1 3.1H3v1h11.3l-3.2 3.3z"></path></svg> <?php 
                    ...
                    <div class="login access">
                        ...
                        <form action="./auth/login" method="post" class="login-form">
                            ...
                            <p>¿No tenes cuenta? <a href="#registrarse" id="register" class="login-form__link">Registrate.</a></p>
                        </form>
                    </div>
    ...
    <div class="modal-register">
        <div class="background"></div>
        <div href="#" class="modal-register__close-button">
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16"><path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"/></svg>
        </div>
        <div class="container">
    ...
    <script>
         ...
         * muestra en el modal la posicion y el tipo de archivo a most
         */
