<?php
    ...
    if (isset($_SESSION['user'])) {
        ...
        $rol = $rol_id == PROFESSOR_ROLE ? 'Profesor' : ($rol_id == ADMIN_ROLE ? 'Administrador' : 'Usuario');
    ...
    <div class="app">
        <header class="header">
            ...
            <div class="header-menu">
                <h1>Tesla</h1>
                <a class="menu-link is-active" href="#biblioteca">Cuenta Personal</a>
            </div>

            <div class="header-profile"> 
                <?php if ($rol_id == PROFESSOR_ROLE) { ?>
