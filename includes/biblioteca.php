        ...
        if (isset($_GET["courseId"]) && isset($_GET["divisionId"])) { 
            ...
            if ($result -> num_rows > 0) {
                while ($row = $result -> fetch_assoc()) { ?>
                    <li>
                        <a href="?subject_id=<?php echo $row['id'] ?>">
                                ...
                                <div class="button-wrapper"> <?php
                                    ...
                                    <div class="menu">
                                        <button class="dropdown">
                                            <ul>
                                                <li>
                                                    <a href="./uploads/subject-<?php echo $_GET['subject_id'] ?>/<?php echo $row['name'] ?>.<?php echo $row['file_type'] ?>" download class="link--descargar" title="Descargar">Descargar</a>
                                                </li> <?php 
                ...
                if ($rol_id > 0) { ?>
                    <tr>
                        <form action="./actions/upload" method="POST" enctype="multipart/form-data">
                            ...
                            <td><input type="text" name="subject_id" value="<?php echo $_GET['subject_id'] ?>" hidden></td>
